...
{
    [Serializable]
    class Devastate : Spells
    {
        readonly Warrior _warrior;
        float[] _damageRatioByLvl = new float[4] { 1.5f, 2f, 2.5f, 4f };

        public Devastate( Warrior warrior)
            :base( "Devastate", 600, "Annihile un ennemi", 7, 0, false, false)
        {
            _warrior = warrior;
